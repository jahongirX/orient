    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                  ...
                  <?= $form->field($model, 'title_uslugi')->textInput(['maxlength' => true]) ?>

                  <?= $form->field($model, 'description_uslugi')->textarea(['rows' => 6]) ?>
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body w-pad">
                ...
                <?= $form->field($model, 'region_id')->dropDownList(\yii\helpers\ArrayHelper::map(\common\models\FilialRegion::find()->all(),'id', 'name'),['class'=>'full-width multi']) ?>
...
<script type="text/javascript">
    var editor = CKEDITOR.replace( 'filial-description', {
...
<script type="text/javascript">
    var editor = CKEDITOR.replace( 'filial-description_uslugi', {
        filebrowserBrowseUrl : '/kcfinder/browse.php?opener=ckeditor&type=files',
        filebrowserImageBrowseUrl : '/kcfinder/browse.php?opener=ckeditor&type=images',
        filebrowserFlashBrowseUrl : '/kcfinder/browse.php?opener=ckeditor&type=flash',
        filebrowserUploadUrl : '/kcfinder/upload.php?opener=ckeditor&type=files',
