...
$this->title = Yii::t('main', 'Маркетинг'); 
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h2 class="title title-page"><?=Yii::t('main', 'Маркетинг')?></h2>
...
<section class="info-block">
    ...
    <div class="container">
        ...
        <span></span>
            ...
            <h2><?= Yii::t('main', 'Маркетинг')?></h2>

            <p><?= Yii::t('main', 'Здоровое питание - главное правило в сохранении человеческого<br>здоровоья. Диетические добавки дают Вашему телу очень много<br>необходимых и полезных веществ')?></p>
